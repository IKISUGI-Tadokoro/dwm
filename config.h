...
static const char col_light0[] = "#fbf1c7";
static const char col_blue[] = "#98971a";
static const char *colors[][3] = {
    /*               fg         bg         border   */
    [SchemeNorm] = {col_light1, col_dark0, col_dark2},
    [SchemeSel] = {col_light0, col_blue, col_blue},
};
...
static const char *screenshot_save_cmd[] = {
    "sh", "-c",
...
static const Key keys[] = {
    ...
    {0, XK_Print, spawn, {.v = screenshotcmd}}, // screenshot then copy
    {MODKEY,
     XK_Print,
     spawn,
